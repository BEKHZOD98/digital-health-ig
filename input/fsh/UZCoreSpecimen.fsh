...
* collection.collector only Reference(UZCorePractitioner or UZCorePractitionerRole or UZCorePatient or UZCoreRelatedPerson)
* collection.collector ^short = "Person who collected the specimen. May be a practitioner, practitioner role, patient (self-collection), or related person (e.g., caregiver)."
